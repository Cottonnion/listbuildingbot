          ...
          <div class="lbb-vertical-content-up">
              <div class="lbb-content lbb-vertical-content lbb-w-100-important">
                <form method="POST" class="lbb-form-settings">
                    <input type="hidden" name="lbb_meta[lbb_chat_background_color]" value="<?php echo $lbb_chat_background_color; ?>">
                    <input type="hidden" name="lbb_meta[lbb_question_background_color]" value="<?php echo $lbb_question_background_color; ?>">
                    <input type="hidden" name="lbb_meta[lbb_ans_bg_color]" value="<?php echo $lbb_ans_bg_color; ?>">
                    ...
                    <div class="lbb-row lbb-align-items-stretch lbb-m-0 lbb-bg-light-gray lbb-height-100vh-120">
                        <div class="lbb-chatbot-preview-form-wrapper">
                            ...
                            <div class="lbb-accordion">
                                <?php if($how_to_show == "minimized" ){
                                    $show_hide_icon_styles = "";
                                }else{
                                    $show_hide_icon_styles = "display:none";
                                } 
                                ?>
                                <div class="lbb-accordion-item show_hide_icon_styles" style="<?php echo $show_hide_icon_styles; ?>">
                                    <div class="lbb-accordion-header">
                                       <h2>Chat Icon </h2>
                                        <div class="lbb-accordion-right-content">
                                            <div class="lbb-accordion-switch">
                                           <div class="lbb-heading-with-switch">
                                              <h2>Global Style</h2>
                                                <div class="lbb-switch">
                                                    <input type="checkbox" id="icon-global-check-info" class="global-check-style checkstyle" <?php echo ($icon_style_global_status == '1') ? 'checked': ''; ?>>
                                                    <input type="hidden" name="lbb_meta[icon_style_global_status]" value="<?php echo $icon_style_global_status; ?>">
                                                    <label for="icon-global-check-info"><span><span></span></span></label>
                                                </div>
                                              </div>
                                            </div>
                                    ...
                                    <div class="lbb-accordion-content lbb-chat-icon-styles-outer" style="display: block;">
                                        <div class="lbb-row">
                                           ...
                                           <!--   -->
                                            ...
                                            <div class="lbb-col-12">
                                                <div class="lbb-form-group">
                                                    <label>Show Chat Header</label>
                                                    <div class="lbb-chekbox-list-wrapper">
                                                        <ul class="lbb-radio-btn-wrapper">
                                                            <li>
                                                                <input type="radio" id="lbb-chat-header-yes" name="lbb_meta[lbb_chat_header]" value="yes" <?php echo $lbb_chat_header == 'yes'?'checked="checked"':''; ?>>
                                                                <label for="lbb-chat-header-yes">Yes</label>
                                                                <div class="lbb-check">
                                                                   <div class="inside"></div>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <input type="radio" id="lbb-chat-header-no" name="lbb_meta[lbb_chat_header]" value="no" <?php echo $lbb_chat_header == 'no'?'checked="checked"':''; ?>>
                                                                <label for="lbb-chat-header-no">No</label>
                                           ...
                                           <!--   -->
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div class="lbb-form-group lbb-radio-buttons"> 
                                                                    <input type="radio" name="lbb_meta[minimized_type]" id="type_icon" value="icon" <?php echo $minimized_type == 'icon'?'checked="checked"':''; ?>>
                                                                    <label for="type_icon">Icon Style</label>
                                                                    <div class="lbb-check"></div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <div class="lbb-form-group lbb-radio-buttons">
                                                                    <input type="radio" name="lbb_meta[minimized_type]" id="type_image" value="image" <?php echo $minimized_type == 'image'?'checked="checked"':''; ?>>
                                                                    <label for="type_image">Image Style</label>
                                                                    <div class="lbb-check"></div>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="lbb-form-group lbb-radio-buttons">
                                                                    <input type="radio" name="lbb_meta[minimized_type]" id="type_video" value="video" <?php echo $minimized_type == 'video'?'checked="checked"':''; ?>>
                                                                    <label for="type_video">Video Style</label>
                                                                    <div class="lbb-check"></div>
                                                                </div>
                                                            </li>
                                                        </ul>
                                            ...
                                            <div class="lbb-col-12">
                                                ...
                                                <div class="lbb-form-group">
                                                    ...
                                                    <div class="lbb-form-group lbb-chatboat-img" style="<?php echo $minimized_type == 'image'?'':'display: none;'; ?>">
                                                        <label>Upload Chatbot Image</label>
                                                        <div class="lbb-common-image-upload-outer lbb-image-upload-container lbb-image-upload-container-with-preview <?php echo (!empty($maximized_chatbot_image)) ? '' : 'lbb-no-img' ?>">
                                                            <div class="lbb-bot-user-image ">
                                                                <a class="lbb-image-upload-button lbb-common-image-upload" href="javascript:void(0)" data-type="lbb_chatbot_icon_options">Upload</a>
                                                                <input type="hidden" id="maximized_chatbot_image" name="lbb_meta[maximized_chatbot_image]" value="<?php echo $maximized_chatbot_image; ?>">
                                                            </div>
                                                            <div class="lbb-image-preview-container">
                                                                <img src="<?php echo $maximized_chatbot_image; ?>" alt="Preview Image" class="lbb-preview-image">
                                                                <div class="lbb-image-actions">
                                                                    <span class="edit-icon"><span class="dashicons dashicons-edit"></span></span>
                                                                    <span class="delete-icon"><span data-type="lbb_chat_icon_image" class="dashicons dashicons-trash"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="lbb-form-group lbb-chatboat-video" style="<?php echo $minimized_type == 'video'?'':'display: none;'; ?>">
                                                        <label>Upload Chatbot Video</label>
                                                          <div class="lbb-common-video-upload-outer lbb-image-upload-container lbb-image-upload-container-with-preview <?php echo (!empty($maximized_chatbot_video)) ? '' : 'lbb-no-img' ?>">
                                                            <div class="lbb-bot-user-image ">
                                                              <a class="lbb-image-upload-button lbb-common-video-upload" href="javascript:void(0)" data-class="show_video" data-type="lbb_chatbot_icon_options">Upload</a>
                                                              <input type="hidden" id="maximized_chatbot_video" name="lbb_meta[maximized_chatbot_video]" value="<?php echo $maximized_chatbot_video; ?>">
                                                            </div>
                                                            <div class="lbb-image-preview-container">
                                                                <img src="<?php echo $multimedia_image; ?>" alt="Preview Image" class="lbb-preview-image">
                                                                <div class="lbb-image-actions">
                                                                    <span class="edit-icon"><span class="dashicons dashicons-edit"></span></span>
                                                                    <span class="delete-icon"><span data-type="lbb_chat_icon_video" class="dashicons dashicons-trash"></span></span>
                                                                </div>
                                                            </div>
                                                          </div>
                                                        </div>
                                                    <div class="lbb-form-group lbb-chatboat-icon" style="<?php echo $minimized_type == 'icon'?'':'display: none;'; ?>">
                                                      <label>Upload Chatbot Icon</label>
                                                      <div class="lbb-common-image-upload-outer lbb-image-upload-container lbb-image-upload-container-with-preview <?php echo (!empty($maximized_chatbot_icon)) ? '' : 'lbb-no-img' ?>">
                                                        <div class="lbb-bot-user-image ">
                                                          <a class="lbb-image-upload-button lbb-common-image-upload" href="javascript:void(0)" data-type="lbb_chatbot_icon_options">Upload</a>
                                                          <input type="hidden" id="maximized_chatbot_icon" name="lbb_meta[maximized_chatbot_icon]" value="<?php echo $maximized_chatbot_icon; ?>">
                                                        </div>
                                                        <div class="lbb-image-preview-container">
                                                            <img src="<?php echo $maximized_chatbot_icon; ?>" alt="Preview Image" class="lbb-preview-image">
                                                            <div class="lbb-image-actions">
                                                                <span class="edit-icon"><span class="dashicons dashicons-edit"></span></span>
                                                                <span class="delete-icon"><span data-type="lbb_chat_icon_image" class="dashicons dashicons-trash"></span></span>
                                                            </div>
                                            ...
                                            <?php
                                            if($minimized_type == 'video'){
                                                $color_text = 'Border Color:';
                                            }else{
                                                $color_text = "Icon Background Color:";
                                            }
                                            ?>

                                            <div class="lbb-col-4">
                                                <div class="lbb-form-group">
                                                    <label class="change-color-text" for="lbb_chat_heading"><?php echo $color_text; ?></label>
                                            ...
                                            <div class="lbb-col-4 chat-hide-for-icon" style="<?php echo $minimized_type == 'icon'?'':'display: none;'; ?>">
                                                <div class="lbb-form-group">
                                            ...
                                            <div class="lbb-col-4 chat-hide-for-image" style="<?php echo ($minimized_type == 'video' || $minimized_type == 'image') ?'':'display: none;'; ?>">
                                                <div class="lbb-form-group">
                                                    <label for="lbb_content_icon_width">Icon Width:</label>
                                                    <div class="lbb-slider-outer">
                                                        <div class="lbb-slider" data-slider-min="50" data-slider-max="300" data-slider-step="1" data-slider-value="<?php echo $lbb_icon_width; ?>" data-value-px="px" data-css-variable="lbb-chat-icon-width"></div>
                                                        <input id="lbb_icon_width" name="lbb_meta[lbb_icon_width]" class="lbb-slider-input lbb-input-field" type="text">
                                                    </div>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="lbb-col-4 chat-hide-for-image" style="<?php echo ($minimized_type == 'video' || $minimized_type == 'image') ?'':'display: none;'; ?>">
                                                <div class="lbb-form-group">
                                                    <label for="lbb_content_icon_height">Icon Height:</label>
                                                    <div class="lbb-slider-outer">
                                                        <div class="lbb-slider" data-slider-min="50" data-slider-max="300" data-slider-step="1" data-slider-value="<?php echo $lbb_icon_height; ?>" data-value-px="px" data-css-variable="lbb-chat-icon-height"></div>
                                                        <input id="lbb_icon_height" name="lbb_meta[lbb_icon_height]" class="lbb-slider-input lbb-input-field" type="text">
                                                    </div>
                                                </div>
                                            </div> 
                                ...
                                <div class="lbb-accordion-item">
                                       ...
                                       <h2>Chatbot</h2>
                                        <div class="lbb-accordion-right-content">
                                           ...
                                           <div class="lbb-heading-with-switch">
                                              <h2>Global Style</h2>
                                                <div class="lbb-switch">
                                                    <input type="checkbox" id="chatbot-global-check-info" class="global-check-style checkstyle" <?php echo ($chatbot_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-chatbot">
                                                    <input type="hidden" name="lbb_meta[chatbot_style_global_status]" value="<?php echo $chatbot_style_global_status; ?>">
                                                    <label for="chatbot-global-check-info"><span><span></span></span></label>
                                                </div>
                                              </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                    ...
                                    <div class="lbb-accordion-content" style="display: none;">
                                        <div class="lbb-row">
                                            <div class="lbb-col-6">
                                                <div class="lbb-form-group">
                                                    <label for="lbb_content_chatbot_width">Chatbot Width:</label>
                                                    <div class="lbb-slider-outer">
                                                        <div class="lbb-slider lbb-container-width" data-slider-min="200" data-slider-max="2000" data-slider-step="1" data-slider-value="<?php echo $lbb_container_width; ?>" data-value-px="px" data-css-variable="lbb-chat-container-width"></div>
                                                        <input id="lbb_container_width" name="lbb_meta[lbb_container_width]" class="lbb-slider-input lbb-input-field" type="text" data-css-variable="lbb-chat-container-width">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="lbb-col-6">
                                                <div class="lbb-form-group">
                                                    <label for="lbb_content_chatbot_height">Chatbot Height:</label>
                                                    <div class="lbb-slider-outer">
                                            ...
                                            <div class="lbb-col-6 lbb-livechat-image" style="<?php echo $chatflow_type == 'livechat' || $chatflow_type == 'botlivechat' ?'':'display: none;'; ?>">
                                                <div class="lbb-form-group">
                                                    <label>Upload Livechat Bot Image</label>
                                       ...
                                       <h2>Background</h2>
                                        <div class="lbb-accordion-right-content">
                                           ...
                                           <div class="lbb-heading-with-switch">
                                              <h2>Global Style</h2>
                                                <div class="lbb-switch">
                                                    <input type="checkbox" id="background-global-check-info" class="global-check-style checkstyle" <?php echo ($lbb_background_style_global_status == '1') ? 'checked': ''; ?>>
                                                    <input type="hidden" name="lbb_meta[lbb_background_style_global_status]" value="<?php echo $lbb_background_style_global_status; ?>">
                                                    <label for="background-global-check-info"><span><span></span></span></label>
                                                </div>
                                              </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                               ...
                                               <ul>
                                                ...
                                                <div class="lbb-col-5">
                                                    <div class="lbb-form-group lbb-style-color" style="<?php echo $lbb_style_chatbot_background == 'color'?'':'display: none;'; ?>">
                                                        ...
                                                        <input type="text" name="" id="lbb_chat_background_color" value="<?php echo $lbb_chat_background_color; ?>" class="lbb-input-field lbb-color-picker" data-other-options="lbb_inner_chat_background_color" data-default-color="<?php echo $lbb_chat_background_color; ?>" data-css-variable="lbb-chat-background-color" />
                                                    </div>
                                                </div>
                                ...
                                <div class="lbb-accordion-item show-hide-heading-subheading" style="<?php echo $how_to_show == 'inline' ? 'display: none;' : ''; ?>">
                                    <div class="lbb-accordion-header">
                                        ...
                                        <div class="lbb-accordion-right-content">
                                            <div class="lbb-accordion-switch">
                                                <div class="lbb-heading-with-switch">
                                                    <h2>Global Style</h2>
                                                    <div class="lbb-switch">
                                                        <input type="checkbox" id="heading-global-check-info" class="global-check-style checkstyle" <?php echo ($heading_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-heading">
                                                        <input type="hidden" name="lbb_meta[heading_style_global_status]" value="<?php echo $heading_style_global_status; ?>">
                                                        <label for="heading-global-check-info"><span><span></span></span></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                        ...
                                        <div class="lbb-accordion-right-content">
                                            <div class="lbb-accordion-switch">
                                                <div class="lbb-heading-with-switch">
                                                    <h2>Global Style</h2>
                                                    <div class="lbb-switch">
                                                        <input type="checkbox" id="question-global-check-info" class="global-check-style checkstyle" <?php echo ($question_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-question">
                                                        <input type="hidden" name="lbb_meta[question_style_global_status]" value="<?php echo $question_style_global_status; ?>">
                                                        <label for="question-global-check-info"><span><span></span></span></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                        ...
                                        <div class="lbb-row">
                                            ...
                                            <div class="lbb-col-4">
                                                <div class="lbb-form-group">
                                                    ...
                                                    <input type="text" name="" id="lbb_question_background_color" value="<?php echo $lbb_question_background_color; ?>" class="lbb-input-field lbb-color-picker" data-other-options="lbb_inner_question_background_color" data-default-color="<?php echo $lbb_question_background_color; ?>" data-css-variable="lbb-question-background-color" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="lbb-accordion-right-content">
                                            <div class="lbb-accordion-switch">
                                                <div class="lbb-heading-with-switch">
                                                    <h2>Global Style</h2>
                                                    <div class="lbb-switch">
                                                        <input type="checkbox" id="answer-global-check-info" class="global-check-style checkstyle" <?php echo ($answer_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-answer">
                                                        <input type="hidden" name="lbb_meta[answer_style_global_status]" value="<?php echo $answer_style_global_status; ?>">
                                                        <label for="answer-global-check-info"><span><span></span></span></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                        ...
                                        <div class="lbb-row">
                                            <div class="lbb-col-4">
                                                <div class="lbb-form-group">
                                                    ...
                                                    <input type="text" id="lbb_ans_bg_color" name="lbb_meta[lbb_ans_bg_color]" data-other-options="lbb_home_ans_bg_color"  value="<?php echo $lbb_ans_bg_color; ?>" class="lbb-input-field lbb-color-picker"  data-default-color="<?php echo $lbb_ans_bg_color; ?>" data-css-variable="lbb-chat-answer-btn-background-color" />
                                                </div>
                                            </div>
                                            <div class="lbb-col-4">
                                                <div class="lbb-form-group">
                                        ...
                                        <div class="lbb-accordion-right-content">
                                            <div class="lbb-accordion-switch">
                                                <div class="lbb-heading-with-switch">
                                                    <h2>Global Style</h2>
                                                    <div class="lbb-switch">
                                                        <input type="checkbox" id="user-answer-global-check-info" class="global-check-style checkstyle" <?php echo ($user_answer_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-user-answer">
                                                        <input type="hidden" name="lbb_meta[user_answer_style_global_status]" value="<?php echo $user_answer_style_global_status; ?>">
                                                        <label for="user-answer-global-check-info"><span><span></span></span></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                    ...
                                    <div class="lbb-accordion-content" style="display: none;">
                                        <div class="lbb-row">
                                            ...
                                            <div class="lbb-col-4">
                                                <div class="lbb-form-group">
                                                    <label for="lbb_ques_bg_color">Background Color:</label>
                                                    <input type="text" name="lbb_meta[lbb_user_answer_background_color]" id="lbb_user_answer_background_color" value="<?php echo $lbb_user_answer_background_color; ?>" class="lbb-input-field lbb-color-picker" data-other-options="lbb_user_answer_background_color" data-default-color="<?php echo $lbb_user_answer_background_color; ?>" data-css-variable="lbb-user-answer-background-color" />
                                                </div>
                                            </div>
                                       ...
                                       <h2>Alignment</h2>
                                        <div class="lbb-accordion-right-content">
                                           ...
                                           <div class="lbb-heading-with-switch">
                                              <h2>Global Style</h2>
                                                <div class="lbb-switch">
                                                    <input type="checkbox" id="alignment-global-check-info" class="global-check-style checkstyle" <?php echo ($alignment_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-alignment">
                                                    <input type="hidden" name="lbb_meta[alignment_style_global_status]" value="<?php echo $alignment_style_global_status; ?>">
                                                    <label for="alignment-global-check-info"><span><span></span></span></label>
                                                </div>
                                              </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                ...
                                <div class="lbb-accordion-item expanded-options-outer" style="<?php echo $minimized_type == 'icon' ? 'display: none;': ''; ?>">
                                    <div class="lbb-accordion-header">
                                       <h2>Expanded</h2>
                                        <div class="lbb-accordion-right-content">
                                            <div class="lbb-accordion-switch">
                                           <div class="lbb-heading-with-switch">
                                              <h2>Global Style</h2>
                                                <div class="lbb-switch">
                                                    <input type="checkbox" id="expanded-global-check-info" class="global-check-style checkstyle" <?php echo ($expanded_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-expanded">
                                                    <input type="hidden" name="lbb_meta[expanded_style_global_status]" value="<?php echo $expanded_style_global_status; ?>">
                                                    <label for="expanded-global-check-info"><span><span></span></span></label>
                                                </div>
                                              </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                            ...
                                            <div class="lbb-col-4">
                                                <div class="lbb-form-group">
                                                    ...
                                                    <div class="lbb-slider-outer">
                                                        ...
                                                        <input id="lbb_max_border_width" name="lbb_meta[max_border_width]" class="lbb-slider-input lbb-input-field" type="text">
                                                    </div>
                                                </div>
                                            </div>
                                       ...
                                       <h2>Shadow</h2>
                                        <div class="lbb-accordion-right-content">
                                           ...
                                           <div class="lbb-heading-with-switch">
                                              <h2>Global Style</h2>
                                                <div class="lbb-switch">
                                                    <input type="checkbox" id="shadow-global-check-info" class="global-check-style checkstyle" <?php echo ($shadow_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-shadow">
                                                    <input type="hidden" name="lbb_meta[shadow_style_global_status]" value="<?php echo $shadow_style_global_status; ?>">
                                                    <label for="shadow-global-check-info"><span><span></span></span></label>
                                                </div>
                                              </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                        ...
                                        <div class="lbb-row">
                                            ...
                                            <div class="lbb-col-4">
                                                <div class="lbb-form-group">
                                                    ...
                                                    <div class="lbb-slider-outer">
                                                        <div class="lbb-slider" data-slider-min="-50" data-slider-max="50" data-slider-step="1" data-slider-value="<?php echo $lbb_shadow_spread_radius; ?>" data-value-px="px" data-css-variable="lbb-shadow-spread-radius"></div>
                                            ...
                                            <div class="lbb-col-4">
                                                <div class="lbb-form-group">
                                                    ...
                                                    <div class="lbb-slider-outer">
                                                        <div class="lbb-slider" data-slider-min="-50" data-slider-max="50" data-slider-step="1" data-slider-value="<?php echo $lbb_shadow_blur_radius; ?>" data-value-px="px" data-css-variable="lbb-shadow-blur-radius"></div>
                                            ...
                                            <div class="lbb-col-4">
                                                <div class="lbb-form-group">
                                                    ...
                                                    <div class="lbb-slider-outer">
                                                        <div class="lbb-slider" data-slider-min="-50" data-slider-max="50" data-slider-step="1" data-slider-value="<?php echo $lbb_shadow_horizontal_length; ?>" data-value-px="px" data-css-variable="lbb-shadow-horizontal-length"></div>
                                            ...
                                            <div class="lbb-col-4">
                                                <div class="lbb-form-group">
                                                    ...
                                                    <div class="lbb-slider-outer">
                                                        <div class="lbb-slider" data-slider-min="-50" data-slider-max="50" data-slider-step="1" data-slider-value="<?php echo $lbb_shadow_vertical_length; ?>" data-value-px="px" data-css-variable="lbb-shadow-vertical-length"></div>
                                ...
                                <div class="lbb-accordion-item back-button-outer" style="<?php echo $lbb_back_button == 'no' ? 'display: none;': ''; ?>">
                                    <div class="lbb-accordion-header">
                                       <h2>Back Button</h2>
                                        <div class="lbb-accordion-right-content">
                                            <div class="lbb-accordion-switch">
                                           <div class="lbb-heading-with-switch">
                                              <h2>Global Style</h2>
                                                <div class="lbb-switch">
                                                    <input type="checkbox" id="back-global-check-info" class="global-check-style checkstyle" <?php echo ($back_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-back">
                                                    <input type="hidden" name="lbb_meta[back_style_global_status]" value="<?php echo $back_style_global_status; ?>">
                                                    <label for="back-global-check-info"><span><span></span></span></label>
                                                </div>
                                              </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                ...
                                <div class="lbb-accordion-item knowledge-button-outer" style="<?php ($lbb_enable_search == 'yes') ? '' : 'display: none;'; ?>">
                                    <div class="lbb-accordion-header">
                                       <h2>Knowledge Base</h2>
                                        <div class="lbb-accordion-right-content">
                                           ...
                                           <div class="lbb-heading-with-switch">
                                              <h2>Global Style</h2>
                                                <div class="lbb-switch">
                                                    <input type="checkbox" id="knowledge-global-check-info" class="global-check-style checkstyle" <?php echo ($knowledge_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-knowledge">
                                                    <input type="hidden" name="lbb_meta[knowledge_style_global_status]" value="<?php echo $knowledge_style_global_status; ?>">
                                                    <label for="knowledge-global-check-info"><span><span></span></span></label>
                                                </div>
                                              </div>
                                            </div>
                                            <span class="lbb-arrow"></span>
                                       ...
                                       <h2>Other Styles</h2>
                                        <div class="lbb-accordion-right-content">
                                           ...
                                           <div class="lbb-heading-with-switch">
                                              <h2>Global Style</h2>
                                                <div class="lbb-switch">
                                                    <input type="checkbox" id="other-global-check-info" class="global-check-style checkstyle" <?php echo ($other_style_global_status == '1') ? 'checked': ''; ?> data-global-class="lbb-global-style-other">
                                                    <input type="hidden" name="lbb_meta[other_style_global_status]" value="<?php echo $other_style_global_status; ?>">
                                                    <label for="other-global-check-info"><span><span></span></span></label>
                                                </div>
                                              </div>
                                            </div>
                                            <span class="lbb-arrow"></span>

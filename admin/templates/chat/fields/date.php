<div class="lbb-inline-input-field lbb-datepicker-field">
    <input type="text" name="lbb_inline_input" id="lbb-datepicker" class="lbb_inline_input lbb-datepicker" placeholder="{{input_placeholder}}" required>
